                ...
                <SView col={"xs-11 sm-10 md-8 lg-6 xl-4"} row>
                    ...
                    <SView col={"xs-12"} style={{ padding: 8 }} center >
                        ...
                        <SView col={"xs-12"}>
                            ...
                            <SHr height={25} />
                            <SView col={"xs-12"} >
                                <SText font={"LondonBetween"} fontSize={16} fontSize={17} fontSize={16} height={30}> <SView backgroundColor={STheme.color.primary} style={{ borderRadius: 20, width: 8, height: 8 }}></SView>  Hematología</SText>
                                <SText font={"LondonBetween"} fontSize={16} fontSize={17} fontSize={16} height={30}> <SView backgroundColor={STheme.color.primary} style={{ borderRadius: 20, width: 8, height: 8 }}></SView>  Química Sanguínea</SText>
                                <SText font={"LondonBetween"} fontSize={16} fontSize={17} fontSize={16} height={30}> <SView backgroundColor={STheme.color.primary} style={{ borderRadius: 20, width: 8, height: 8 }}></SView>  Micología</SText>
                                <SText font={"LondonBetween"} fontSize={16} fontSize={17} fontSize={16} height={30}> <SView backgroundColor={STheme.color.primary} style={{ borderRadius: 20, width: 8, height: 8 }}></SView>  Serología</SText>
                                <SText font={"LondonBetween"} fontSize={16} fontSize={17} fontSize={16} height={30}> <SView backgroundColor={STheme.color.primary} style={{ borderRadius: 20, width: 8, height: 8 }}></SView>  Hormonas</SText>
                                <SText font={"LondonBetween"} fontSize={16} fontSize={17} fontSize={16} height={30}> <SView backgroundColor={STheme.color.primary} style={{ borderRadius: 20, width: 8, height: 8 }}></SView>  Marcadores Tumorales</SText>
                                <SText font={"LondonBetween"} fontSize={16} fontSize={17} fontSize={16} height={30}> <SView backgroundColor={STheme.color.primary} style={{ borderRadius: 20, width: 8, height: 8 }}></SView>  Exámenes de Orina</SText>
                                <SText font={"LondonBetween"} fontSize={16} fontSize={17} fontSize={16} height={30}> <SView backgroundColor={STheme.color.primary} style={{ borderRadius: 20, width: 8, height: 8 }}></SView>  Parasitologia</SText>
                                <SText font={"LondonBetween"} fontSize={16} fontSize={17} fontSize={16} height={30}> <SView backgroundColor={STheme.color.primary} style={{ borderRadius: 20, width: 8, height: 8 }}></SView>  Bacteriologia</SText>
                                <SText font={"LondonBetween"} fontSize={16} fontSize={17} fontSize={16} height={30}> <SView backgroundColor={STheme.color.primary} style={{ borderRadius: 20, width: 8, height: 8 }}></SView>  Exámenes Especiales</SText>
                                <SText font={"LondonBetween"} fontSize={16} fontSize={17} fontSize={16} height={30}> <SView backgroundColor={STheme.color.primary} style={{ borderRadius: 20, width: 8, height: 8 }}></SView>  Examenes de Covid-19</SText>
                            </SView>
                        </SView>
                        <SHr height={25} />

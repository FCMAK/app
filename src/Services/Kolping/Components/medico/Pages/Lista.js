    ...
    getContent() {
        ...
        return <STable2
            header={[
                ...
                { key: "smmed_cmed", label: "key", width: 50 },
                {
                    key: "smmed_cmed-foto", label: "foto", width: 100,
                    render: (item) => {
                ...
                { key: "smmed_cesp", label: "Especialidad", width: 150, render: (item) => { return especialidades[item]?.smtur_desp } },

    ...
    getContent() {
        ...
        return <SForm
            ...
            inputs={{
                ...
                smmed_cesp: {
                    label: "Codigo especialidad", value: this.state.smmed_cesp, isRequired: true, defaultValue: this.data["smmed_cesp"], editable: false, onPress: () => {
                        SNavigation.navigate("especialidad/select", {
                            onSelect: (data) => {
                                this.setState({
                                    smmed_cesp: data.smtur_cesp
                                })
                            }
                        });
                    }

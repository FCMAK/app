...
import { SButtom, SHr, SIcon, SPage, SScrollView2, SText, STheme, SView, } from 'servisofts-component';
        ...
        return <>
            <SPage title={'Términos y condiciones'}>
                <SView col={"xs-12"} center height>
                    <SView col={"xs-11 md-6 xl-4"} center height   >
                        <SView col={"xs-11"} center flex    >
                            <SScrollView2 disableHorizontal center>
                                <SView col={"xs-11"}   >
                                    <SText color={STheme.color.black} fontSize={14} style={{ paddingTop: 5, paddingBottom: 5, textAlign: "Justify" }} font={"LondonMM"}>
                        ...
                        <SView col={"xs-11"} center height={120}   >
                            <SView col={"xs-12"} height={30} row center    >
                                <SView col={"xs-1"} height center>
                                    <SIcon name='IconChecked' fill={STheme.color.primary} width={18} height={18}></SIcon>
                                </SView>
                                <SView col={"xs-11"} height center style={{ alignItems: "flex-start" }} >
                                    <SText color={STheme.color.black} fontSize={14} font={"LondonBetween"}>Aceptar términos y Condiciones</SText>
                                </SView>
                            </SView>
                            <SView height={10} />
                            <SView>

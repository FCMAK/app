    ...
    getEnfermeras() {
        ...
        return cantidad.map((obj, i) => {
            return <SView height={500} width={200} center style={{
                ...
                <SText color={"#000"}>{`Enfermera${i + 1}`}</SText>
            ...
            <SPage title={'Test'}>
                <SView col={"xs-12"} center >
                    ...
                    <SView col={"xs-11"} row>
                        ...
                        <SView col={"xs-12 md-6 xl-4"} style={{ padding: 8 }} >
                            <SText backgroundColor={STheme.color.secondary} height={50} fontSize={18} center font={"LondonTwo"} color={"#000"}>secondary {`\n${STheme.color.secondary}`}</SText>

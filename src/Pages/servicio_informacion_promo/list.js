...
class index extends DPA.list {
    constructor(props) {
        ...
        this.key_servicio = SNavigation.getParam("key")
    ...
    onNew() {
        super.onNew({ key: this.key_servicio })
    }
    ...
    $filter(data) {
        return data.estado != 0 && data.key_servicio_informacion === this.key_servicio
    }
    $getData() {
    ...
    onDelete(obj) {
        if (this.deletePermiso) {
            SPopup.confirm({
                ...
                message: "¿Seguro que desea remover el banner de promoción?",
                onPress: () => {
            ...
            SPopup.alert("No tiene permisos para eliminar el banner de promoción")
        }
    }
            ...
            <SView card>
                <SView padding={10}>
                    ...
                    >
                        ...
                        <SImage enablePreview src={SSocket.api.root + "servicio_informacion_promo/" + obj?.key + "?date=" + new Date().getTime()} style={{
                            width: "100%",
                            height: "100%",
                            resizeMode: "contain",
                            borderRadius: 4,

                    ...
                    onPress={() => {
                        ...
                        if (Platform.OS == "android") {
                            ...
                            //    Linking.openURL("https://play.google.com/store/apps/details?id=com.staffprousa_app")
                               Linking.openURL("https://play.google.com/store/apps/details?id=com.kolping_app3")
                            // Linking.openURL("https://driver.tapekeapp.com/#features")
                            ...
                            Linking.openURL("https://apps.apple.com/bo/app/kolping-app/id6737493876")
                            // SPopup.alert("NO DISPONIBLE");
                        }

                    }}>
                    <SText fontSize={16} bold color={STheme.color.secondary}>Actualizar</SText>
                </SView>
                <SHr h={50} />
            </Container>
        </SPage>

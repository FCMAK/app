...
import IconServicio, { ReactComponent as IconServicioW } from './svg/iconServicio.svg';
import FlechaServicio, { ReactComponent as FlechaServicioW } from './svg/flechaServicio.svg';
import Horario, { ReactComponent as HorarioW } from './svg/horario.svg';
import Costo, { ReactComponent as CostoW } from './svg/costo.svg';
import Sucursal, { ReactComponent as SucursalW } from './svg/sucursal.svg';

import BtnAccept, { ReactComponent as BtnAcceptW } from './svg/btnAccept.svg';
import BtnCancel, { ReactComponent as BtnCancelW } from './svg/btnCancel.svg';
import BtnShooter, { ReactComponent as BtnShooterW } from './svg/btnShooter.svg';
...
const Assets: SAssets = {
    svg: {
        ...
        "Obs": { Native: Obs, Web: ObsW },
        "Camera": { Native: Camera, Web: CameraW },
        "BackArrow": { Native: BackArrow, Web: BackArrowW },
        "IconServicio": { Native: IconServicio, Web: IconServicioW },
        "FlechaServicio": { Native: FlechaServicio, Web: FlechaServicioW },
        ...
        "BtnShooter": { Native: BtnShooter, Web: BtnShooterW },
